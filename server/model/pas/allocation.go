...
type Allocation struct {
      ...
      OriginalScore  float64 `json:"OriginalScore" form:"OriginalScore" gorm:"column:OriginalScore;comment:原始分数;type:float;"`
      AdjustedScore  float64 `json:"AdjustedScore" form:"AdjustedScore" gorm:"column:AdjustedScore;comment:修改后的分数;type:float;"`
      ...
      Evaluation Evaluation `json:"evaluation" gorm:"foreignKey:ID;references:ID;comment:方案"`
}
